...
export default function SingleRoom() {
  const room = {
    id: 2,
    type: "Single Room",
    description: "A cozy single room ideal for solo travelers, with a comfortable bed and essential amenities.",
    price: 2000,
    discountedPrice: 1800,
    available: 5,
    image: "https://images.pexels.com/photos/271618/pexels-photo-271618.jpeg",
    features: ["Free WiFi", "Air Conditioning", "TV", "Desk", "Wardrobe"],
  };
  ...
  const extraPrices = { breakfast: 300, airportPickup: 800 };
  ...
  return (
    <>
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-teal-100 py-8 px-4 mt-20">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10">
            <h1 className="text-4xl font-bold text-gray-800 mb-4">Luxury Hotel & Resort</h1>
            <p className="text-gray-600">Experience comfort and convenience in our Single Room</p>
          </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6">
              ...
              <div className="border-t border-gray-200 pt-6">
                ...
                <div className="flex justify-between items-center mt-6">
                  ...
                  <button onClick={() => setShowModal(true)} className="py-3 px-6 bg-gradient-to-r from-green-500 to-teal-700 text-white font-bold rounded-lg">
          ...
          <div className="fixed inset-0 backdrop-blur-sm bg-black/50 flex items-center justify-center z-50">
            <div className="bg-white rounded-2xl shadow-xl max-w-lg w-full p-6 relative">
              ...
              <form onSubmit={handleBookingSubmit} className="space-y-4">
                ...
                <button type="submit" className="w-full py-3 bg-teal-600 text-white font-bold rounded-lg">Confirm Booking - ₹{totalPrice}</button>
              </form>
            </div>
          </div>
        )}
