...
export default function ExecutiveSuite() {
  const room = {
    ...
    description: "Elegant and cozy room perfect for couples and small families.",
    price: 13999,
    discountedPrice: 12599,
    available: 6,
    image: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=500&auto=format&fit=crop&q=60",
    features: ["Free WiFi", "Air Conditioning", "TV", "Mini Bar", "Comfortable Beds"]
  };
  ...
  const extraPrices = { breakfast: 500, airportPickup: 700, spaAccess: 1500 };

  // Price calculation guests and nights
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 py-8 px-4 mt-20">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600">Experience elegance and comfort in our Executive Suite</p>
          </div>
